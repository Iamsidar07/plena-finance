            ...
            <View style={styles.cartItemContainer}>
                <View style={styles.cartItem}>
                    ...
                    <View style={styles.cartItemRight}>
                        <Pressable style={styles.increaseQuantityTextContainer} onPress={() => increaseQuantity(item.id)}>
                            <Text style={styles.controller}>+</Text>
                        </Pressable>
                        <Text style={styles.cartItemQuantity}>{item.quantity}</Text>
                        <Pressable style={styles.increaseQuantityTextContainer} onPress={() => decreaseQuantity(item.id)}>
                            <Text style={styles.controller}>-</Text>
                        </Pressable>
                    </View>
                </View>
